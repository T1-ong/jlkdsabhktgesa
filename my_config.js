...
module.exports = Object.freeze({
    ...
    default_config: {
         ...
         * 监视更转的用户uid
         */
        UIDs: [79559649, 310361936, 3546756407102316, 495974813],
         ...
         * 保存抽奖信息至文件
         */
        save_lottery_info_to_file: false,  // 修改为true，所有账号都会保存抽奖信息
         ...
         * - 预约抽奖可能与转发抽奖并存
         */
        is_not_relay_reserve_lottery: true,
         ...
         * | 专栏       | `64`   |
         */
        block_dynamic_type: [64, 512, 2048],
         ...
         * - 单位毫秒
         */
        update_session_wait: 3000,

        /**
         * - 读取下一页关注列表间隔
         * - 单位毫秒
         */
        get_partition_wait: 3000,

        /**
         * - 获取动态细节间隔
         * - 单位毫秒
         */
        get_dynamic_detail_wait: 2350,
         ...
         * 转发时[at]的用户
         */
        at_users: [['转发抽奖娘', 294887687], ['你的工具人老公', 100680137], ['翔翔1234', 256316789]],
        ...
        /**
         * 答题关键词
         * 包含这些关键词的动态需要答题，可以选择跳过或特殊处理
         */
        answer_keywords: ['答题', '回答', '正确', '回答问题', '选择正确', '选择出', '选出'],
         ...
         * 热评屏蔽词
         */
        copy_blockword: ['三不原则', '口罩', '疫情', '领导', '政府', '国家', '死', '自由', '红', '政策', '中国', '军', '主席', '习', '加里奥', '片', '燥', 'm', '.', '`', '·', '点', 'zf', '政', '法', '党', '国', 'jc', '叔叔', '公安', '警察', '军', '干', '操', '感恩', '反思', 's', '赢', '润', '国内', '国外', '梯子', '外网', '爆', '麦', 'v', '私', '纯', '祝大', '这就是'],
        ...
        notice_key_words: [
            '~预约成功|预约主题',
            '中奖|获得|填写|写上|提供|收货地址|zfb|支付宝|E卡|e卡|京东卡|码|大会员|恭喜|获奖',
            '~你的账号在新设备或平台登录成功',
            '~你预约的直播已开始'
        ],
